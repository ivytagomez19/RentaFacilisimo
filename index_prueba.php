            ...
            <form action="#" method="post" class="hotel-search-form">
									<div class="row">
										<div class="col-lg-2 col-md-6 form-group">
							          	...
							          	<div class="col-lg-3 col-md-6 form-group">
							            	 <select class="form-control">
							            	 	...
							            	 	<option value="001001">Campeche</option>
                                                <option value="001002">Champotón</option>
												<option value="001003">Ciudad del Carmen</option>	                                       										
											</select> 
							          	</div>
							            <div class="col-lg-3 col-md-6 form-group">
							            	 <select class="form-control">
                                        ...
                                        <div class="col-lg-2 col-md-6">
			            					<button type="submit" name="submit" class="btn btn-primary btn-lg btn-block"> <i class="fa fa-search"></i>&nbsp;Buscar</button>
						            	</div>
									</div>							
